    ...
    <div className={s.root}>
      <div className={s.top}>
        <NavBarButton
          ...
          icon={<GradeIcon width={20} height={20} viewBox="0 0 32 32" />}
        ...
        <NavBarButton
          ...
          icon={<ScheduleIcon width={20} height={20} viewBox="0 0 32 32" />}
      ...
      <div className={s.bottom}>
        <NavBarButton
          ...
          icon={<UserIcon width={40} height={40} viewBox="0 0 40 40" />}
        ...
        <NavBarButton
          ...
          icon={<LogoutIcon width={20} height={20} viewBox="0 0 32 32" />}
